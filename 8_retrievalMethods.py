...
#Query to test
query = "where is tesla headquaters located in?"
print(f"Query: {query}\n")
...
# print(f"Retieved {len(docs)} documents:\n")
...
# when we use MMR--------:
# 1.documents might have overlapping content
# 2.want a well rounded answer covering different aspects
# 3.want relevant info

#  don't use MMR when
#  1. you want the absolute most relevant results
#  2. your chunks are already quit diverse
#  3. speed is critical (MMR is slowwer) 
